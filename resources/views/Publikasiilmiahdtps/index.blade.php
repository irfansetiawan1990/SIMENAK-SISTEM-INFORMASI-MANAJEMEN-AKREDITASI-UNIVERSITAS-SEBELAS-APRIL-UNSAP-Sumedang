 ...
 <!-- Content Header (Page header) -->
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Publikasi Ilmiah DTPS</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home">Home</a></li>
              <li class="breadcrumb-item active">Publikasi Ilmiah DTPS</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEdit" aria-hidden="true">
                 <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    ...
                    <!--FORM TAMBAH PS-->
                          <form action="{{ route('Publikasiilmiahdtps.store') }}" method="POST">
                            @csrf
                                  <div class="form-group">
                                    <label for="">Media Publikasi</label>
                                    <input type="text" class="form-control" id="media_publikasi" name="media_publikasi" aria-describedby="emailHelp">
                                  </div>
                                  <div class="form-group">
...
<div class="card-body">
  <div style="overflow-x:auto;">
    <table border="1"cellpadding="10">
      ...
      <td rowspan="2" width="300px" class="text-center">Media Publikasi</td>
    ...
    @foreach ($Publikasiilmiahdtps as $item)
    <tr>
      <td width="10px" class="text-center">{{++$i}}</td>
      <td width="300px">{{$item->media_publikasi}}</td>
      ...
      <td width="10px">
         <!-- Tombol untuk menampilkan modal-->
              ...
              <!--modal edit -->
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_publikasi}}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_publikasi }}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                           <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                    <!--FORM TAMBAH PS-->
                        <form action="{{ route('Publikasiilmiahdtps.update', $item->id_publikasi) }}" method="POST">
                            @csrf
                            @method('PUT')

                                  <div class="form-group">
                                    <label for="">Media Publikasi</label>
                                    <input type="text" class="form-control" id="media_publikasi" name="media_publikasi" aria-describedby="emailHelp" value="{{$item->media_publikasi}}">
                                  </div>
                                  <div class="form-group">
                                    <label for="">TS-2</label>
                  ...
                  <form action="{{ route('Publikasiilmiahdtps.destroy',$item->id_publikasi)  }}" method="POST">
                    @csrf
                    @method('DELETE')
