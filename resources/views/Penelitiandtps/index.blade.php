...
@section('content')
 <!-- Content Header (Page header) -->
  ...
  <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit">Tambah</button>
    ...
    <BR>
    <BR>Tuliskan jumlah judul penelitian <br>
     1) yang dilaksanakan oleh DTPS berdasarkan sumber pembiayaan, yang relevan dengan bidang program studi pada TS-2 sampai dengan TS.
                 ...
                 <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                          <h5 class="modal-title">Tambah Data Penelitian DTPS</h5>
                    ...
                    <!--FORM TAMBAH PS-->
                          <form action="{{ route('Penelitiandtps.store') }}" method="POST">
                            @csrf
...
<div class="card-body">
  <div style="overflow-x:auto;">
    <table border="1"cellpadding="10">
      ...
      <td rowspan="2" width="200px" class="text-center">Sumber Pembiayaan</td>
      <td colspan="3" width="20px" class="text-center">Jumlah judul penelitian</td>
    ...
    @foreach ($Penelitiandtps as $item)
    <tr>
      ...
      <td width="10px">
         <!-- Tombol untuk menampilkan modal-->
              ...
              <!--modal edit -->
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_penelitian}}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_penelitian }}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                           <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <!--FORM TAMBAH PS-->
                                ...
                                <form action="{{ route('Penelitiandtps.update',$item->id_penelitian) }}" method="POST">
                            @csrf
                            @method('PUT')
                    ...
                    <form action="{{ route('Penelitiandtps.destroy',$item->id_penelitian) }}" method="POST">
                    @csrf
                    @method('DELETE')
    ...
    Keterangan: <br>
    1) Kegiatan penelitian tercatat di unit/lembaga yang mengelola kegiatan penelitian di tingkat Perguruan Tinggi/UPPS. <br>
    2) Penelitian dengan sumber pembiayaan dari DTPS. 
