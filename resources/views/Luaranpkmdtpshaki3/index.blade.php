            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEdit" aria-hidden="true">
                 <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    ...
                    <!--FORM TAMBAH PS-->
                          <form action="{{ route('Luaranpkmdtpshaki3.store') }}" method="POST">
                            @csrf
...
<div class="card-body">
  <div style="overflow-x:auto;">
    <table border="1"cellpadding="10">
        ...
        @foreach ($Luaranpkmdtpshaki3 as $item)
        <tr>
            <td ></td>
            ...
            <!--modal edit -->
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_pkm_dtps_haki3 }}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_pkm_dtps_haki3}}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                           <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <!--FORM TAMBAH PS-->
                                ...
                                <form action="{{ route('Luaranpkmdtpshaki3.update',$item->id_pkm_dtps_haki3)}}" method="POST">
                            @csrf
                            @method('PUT')
                    ...
                    <form action="{{ route('Luaranpkmdtpshaki3.destroy',$item->id_pkm_dtps_haki3) }}" method="POST">
                    @csrf
                    @method('DELETE')
