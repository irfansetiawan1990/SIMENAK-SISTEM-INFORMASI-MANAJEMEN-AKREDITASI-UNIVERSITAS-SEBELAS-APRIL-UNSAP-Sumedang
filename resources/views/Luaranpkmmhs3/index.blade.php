            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEdit" aria-hidden="true">
                 <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    ...
                    <!--FORM TAMBAH PS-->
                          <form action="{{ route('Luaranpkmmhs3.store') }}" method="POST">
                            @csrf
                          ...
                          <button type="submit" class="btn btn-primary" onclick="return confirm('Apakah Anda yakin data yang anda masukan sudah valid?')">Simpan Data</button>
                          </form>
  ...
  <div style="overflow-x:auto;">
    <table border="1"cellpadding="10">
        ...
        <tr>
            ...
            <th width="300px" ><p style="text-align: justify;">
        ...
        <tr>
            ...
            <!--modal edit -->
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_pkm_mhs3 }}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_pkm_mhs3}}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                           <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <!--FORM TAMBAH PS-->
                                ...
                                <form action="{{ route('Luaranpkmmhs3.update',$item->id_pkm_mhs3)}}" method="POST">
                            @csrf
                            @method('PUT')
                    ...
                    <form action="{{ route('Luaranpkmmhs3.destroy',$item->id_pkm_mhs3) }}" method="POST">
                    @csrf
                    @method('DELETE')
