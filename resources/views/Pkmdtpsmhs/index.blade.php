        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pengabdian Kepada Masyarakat</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">PkM DTPS yang melibatkan Mahasiswa</h3>
        ...
        <div class="card-body">
          ...
          <!-- Tombol untuk menampilkan modal-->
             ...
             @if (auth()->user()->level=="user")
                ...
                <a class="btn btn-primary btn-sm" href="{{route('Pkmdtpsmhs.create')}}" role="button">Tambah</a>
  ...
  <div class="overflow-auto">
    <table border="1"cellpadding="5" style="width:100%">
        <tr bgcolor="#DCDCDC">
                  ...
                  <td class="text-center" width="200px">Judul Kegiatan</td>
                  <td class="text-center" class="text-center" width="10px">Tahun</td>
                  <td class="text-center">Aksi</td>
          </tr>
        
        @foreach ($Pkmdtpsmhs as $item)
          <tr>
            ...
            <!--modal edit -->
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_pkm_dtps_mhs }}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_pkm_dtps_mhs}}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <!--FORM TAMBAH PS-->                           
                              <form action="{{ route('Pkmdtpsmhs.update',$item->id_pkm_dtps_mhs) }}" method="POST">
                                @csrf
                                @method('put')
                                  <div class="form-row">
                  ...
                  <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalCenter{{$item->id_pkm_dtps_mhs}}">
                    delete
                  </button>

                  <!-- Modal -->
                  <div class="modal fade" id="exampleModalCenter{{$item->id_pkm_dtps_mhs}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <form action="{{ route('Pkmdtpsmhs.destroy',$item->id_pkm_dtps_mhs) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
