    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"> Tambah Data Dosen Tetap Perguruan Tinggi</h3>
                            ...
                            @csrf
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nidn" name="nidn" aria-describedby="emailHelp">
                                    </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="kesesuaian_inti_ps" name="kesesuaian_inti_ps">
                                  </div>
                                    <div class="form-group">
