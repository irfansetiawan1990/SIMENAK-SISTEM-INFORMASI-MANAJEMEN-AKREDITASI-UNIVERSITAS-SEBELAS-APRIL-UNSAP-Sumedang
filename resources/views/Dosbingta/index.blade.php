 ...
 <!-- Content Header (Page header) -->
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Dosen Pembimbing tugas Akhir</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home">Home</a></li>
              <li class="breadcrumb-item active">Dosen Pembimbing tugas Akhir</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Dosen Pembimbing tugas Akhir</h3>
                 ...
                 <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                          <h5 class="modal-title">Tambah Dosen Pembimbing tugas Akhir</h5>
                ...
                <div class="modal fade" id="modalEdit{{ $item->id_dosen_pembimbing }}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                  ...
                  <div class="modal-content">
                    ...
                    <!--FORM TAMBAH PS-->
                            ...
                            <form action="{{ route('Dosbingta.update',$item->id_dosen_pembimbing) }}" method="POST">
                            @csrf
                            @method('PUT')
                                  <div class="form-group">
                                    <label for="">Nama Dosen</label>
                    ...
                    <form action="{{ route('Dosbingta.destroy',$item->id_dosen_pembimbing) }}" method="POST">
                    @csrf
                    @method('DELETE')
