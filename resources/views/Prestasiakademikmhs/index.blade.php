        ...
        <div class="card-body">
          ...
          <!-- Tombol untuk menampilkan modal-->
             ...
             @if (auth()->user()->level=="user")
                ...
                <a class="btn btn-primary btn-sm" href="{{route('Prestasiakademikmhs.create')}}" role="button">Tambah</a>
...
<div class="card-body">
  ...
  <div class="overflow-auto">
    <table border="1"cellpadding="5" style="width:90%">
        ...
        @foreach ($Prestasiakademikmhs as $item)
          <tr>
            ...
            <!--modal edit -->  
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_prestasi_akademik_mhs }}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_prestasi_akademik_mhs}}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <!--FORM TAMBAH PS-->                           
                                <form action="{{ route('Prestasiakademikmhs.update',$item->id_prestasi_akademik_mhs) }}" method="POST">
                                  @csrf
                                  @method('put')
                                    <div class="form-row">
                  ...
                  <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalCenter{{$item->id_prestasi_akademik_mhs}}">
                    delete
                  </button>

                  <!-- Modal -->
                  <div class="modal fade" id="exampleModalCenter{{$item->id_prestasi_akademik_mhs}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <form action="{{ route('Prestasiakademikmhs.destroy',$item->id_prestasi_akademik_mhs) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
