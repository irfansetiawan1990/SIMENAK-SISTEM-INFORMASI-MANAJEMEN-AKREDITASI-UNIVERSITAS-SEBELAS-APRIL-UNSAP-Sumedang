            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEdit" aria-hidden="true">
                 <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    ...
                    <!--FORM TAMBAH PS-->
                          <form action="{{ route('Luaranpkmmhs.store') }}" method="POST">
                            @csrf
        ...
        <tr>
            ...
            <td >
              ...
              <!--modal edit -->
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_pkm_mhs }}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_pkm_mhs}}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                           <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <!--FORM TAMBAH PS-->
                                ...
                                <form action="{{ route('Luaranpkmmhs.update',$item->id_pkm_mhs)}}" method="POST">
                            @csrf
                            @method('PUT')
                    ...
                    <form action="{{ route('Luaranpkmmhs.destroy',$item->id_pkm_mhs) }}" method="POST">
                    @csrf
                    @method('DELETE')
