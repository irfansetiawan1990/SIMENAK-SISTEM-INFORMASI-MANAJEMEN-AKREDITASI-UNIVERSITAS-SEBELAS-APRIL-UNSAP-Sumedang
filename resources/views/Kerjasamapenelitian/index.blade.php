        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Kerjasama Penelitian</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                          <h5 class="modal-title">Tambah Kerjasama Penelitian</h5>
                    ...
                    <!--FORM TAMBAH PS-->
                          <form action="{{ route('Kerjasamapenelitian.store') }}" method="POST">
                            @csrf
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td width="100px">
              ...
              <!--modal edit -->
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_kjpl }}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_kjpl }}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <!--FORM TAMBAH PS-->
                                ...
                                <form action="{{ route('Kerjasamapenelitian.update', $item->id_kjpl) }}" method="POST">
                                  @csrf
                                  @method('PUT')
                                 <div class="form-group">
                                    <label for="">Lembaga Mitra</label>
                    ...
                    <form action="{{ route('Kerjasamapenelitian.destroy',$item->id_kjpl) }}" method="POST">
                    @csrf
                    @method('DELETE')
