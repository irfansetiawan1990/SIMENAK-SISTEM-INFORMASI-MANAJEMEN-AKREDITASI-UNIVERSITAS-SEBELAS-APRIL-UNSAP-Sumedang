 ...
 <!-- Content Header (Page header) -->
  <section class="content-header">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Kerjasama Pendidikan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                          <h5 class="modal-title">Tambah Kerjasama Pendidikan</h5>
                    ...
                    <!--FORM TAMBAH PS-->
                          <form action="{{ route('Kerjasamapendidikan.store') }}" method="POST">
                            @csrf
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="tahun_berakhir_kjsm" name="tahun_berakhir_kjsm">
                                  </div>
    ...
    <table class="table table-bordered">
        ...
        @foreach ($Kerjasamapendidikan as $item)
        <tr>
            ...
            <td width="280px">{{ $item->tahun_berakhir_kjsm }}</div></td>
            <td width="100px">

              <!--modal edit -->
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_kerjasamapendidikan }}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_kerjasamapendidikan }}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <!--FORM TAMBAH PS-->
                                ...
                                <form action="{{ route('Kerjasamapendidikan.update', $item->id_kerjasamapendidikan) }}" method="POST">
                                ...
                                @endif
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label for="">Tahun Berakhir</label>
                                      <input type="text" class="form-control" id="tahun_berakhir_kjsm" name="tahun_berakhir_kjsm" value="{{$item->tahun_berakhir_kjsm}}">
                                  </div>
                    ...
                    <form action="{{ route('Kerjasamapendidikan.destroy',$item->id_kerjasamapendidikan) }}" method="POST">
                    @csrf
                    @method('DELETE')
