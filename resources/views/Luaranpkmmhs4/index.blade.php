            ...
            <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEdit" aria-hidden="true">
                 <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    ...
                    <!--FORM TAMBAH PS-->
                          <form action="{{ route('Luaranpkmmhs4.store') }}" method="POST">
                            @csrf
...
<div class="card-body">
  <p>Tuliskan luaran penelitian dan luaran PkM yang dihasilkan mahasiswa, baik secara 
mandiri atau bersama DTPS, dalam 3 tahun terakhir dengan mengikuti format Tabel 
8.f.4) berikut ini. Jenis dan judul luaran harus relevan dengan bidang program studi.</p>
  <div style="overflow-x:auto;">
    <table border="1"cellpadding="10">
        <tr bgcolor="#DCDCDC">
            <th width="10px"  class="text-center">No</th>
            <th width="100px"  class="text-center">Judul luaran penelitian dan PkM (HKI)</th>
            <th width="50px" class="text-center">Tahun</th>
        ...
        <tr>
            <th width="10px"  class="text-center">III</th>
            <th width="300px" ><p style="text-align: justify;">Buku Ber-ISBN, Book Chapter
            </p>
            </th>
        ...
        <tr>
            ...
            <!--modal edit -->
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{  $item->id_pkm_mhs4 }}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_pkm_mhs4}}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                           <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <!--FORM TAMBAH PS-->
                                ...
                                <form action="{{ route('Luaranpkmdtpshaki4.update',$item->id_pkm_mhs4)}}" method="POST">
                            @csrf
                            @method('PUT')
                    ...
                    <form action="{{ route('Luaranpkmdtpshaki4.destroy',$item->id_pkm_mhs4) }}" method="POST">
                    @csrf
                    @method('DELETE')
